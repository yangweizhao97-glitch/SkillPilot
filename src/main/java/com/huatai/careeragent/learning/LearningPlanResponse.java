...
public record LearningPlanResponse(Long planId, Long taskId, Long reportId, Map<String, Object> plan,
                                   String schemaVersion, String planMode, LocalDate interviewDate,
                                   Integer daysRemaining, Map<String, Object> request,
    ...
    public static LearningPlanResponse from(LearningPlan value) {
        ...
        return new LearningPlanResponse(value.getId(), value.getTaskId(), value.getReportId(), value.getResultJson(),
                value.getSchemaVersion(), value.getPlanMode(), value.getInterviewDate(), value.getDaysRemaining(),
                value.getRequestJson(), value.getCreatedAt(), value.getUpdatedAt());
    }
}
